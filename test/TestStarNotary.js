...
it('lets a user transfer a star', async() => {
    ...
    const star_1 = accounts[0];
    const star_2 = accounts[1];
    await instance.createStar('awesome star!', tokenId, {from: star_1});
    await instance.transferStar(star_2, tokenId, {from: star_1});
    assert.equal(await instance.ownerOf.call(tokenId), star_2); 
